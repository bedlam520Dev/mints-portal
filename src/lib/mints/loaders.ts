...
type ClaimCondition1155 = Awaited<
	ReturnType<typeof getErc1155ActiveClaimCondition>
>;
type ClaimCondition721 = Awaited<
	ReturnType<typeof getErc721ActiveClaimCondition>
>;

type AnyClaimCondition = ClaimCondition1155 | ClaimCondition721;
type DropNFT =
	| Awaited<ReturnType<typeof getErc1155NFT>>
	| Awaited<ReturnType<typeof getErc721NFT>>;
...
const summarizeClaimCondition = async (
	...
	return {
		...
		quantityLimitPerWallet:
			condition.quantityLimitPerWallet?.toString() ?? null,
		startTimestamp:
...
const buildMintFromNft = async (
	...
	const contractInstance = buildContractInstance(config);
